...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254797695832",  
    ...
    HEROKU_APP_NAME : process.env.HEROKU_APP_NAME || "desperende",
    HEROKU_API_KEY : process.env.HEROKU_API_KEY ||"HRKU-d8f0a222-4ac9-4c24-8672-f13f84031adc",
